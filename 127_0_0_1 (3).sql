...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-05-2024 a las 23:50:50
...
(57, 'Can add solicitud pago', 15, 'add_solicitudpago'),
(58, 'Can change solicitud pago', 15, 'change_solicitudpago'),
(59, 'Can delete solicitud pago', 15, 'delete_solicitudpago'),
(60, 'Can view solicitud pago', 15, 'view_solicitudpago');
...
(1, 'pbkdf2_sha256$216000$lyL9KDSkeQjQ$Btj2tEvlK48fQq0+ZB2e/GQJTp15QtqkvadAfpwK6tk=', '2024-05-25 20:01:51.115062', 1, 'admin', '', '', 'asdads@asd.com', 1, 1, '2023-07-10 00:56:40.000000'),
...
(4, 'pbkdf2_sha256$720000$Nle4dgESCHHvGnmbqHj9Mu$irr3QnjNiFV6P52x/pj2MqOSfpdp8Osq7rgnvU+rKEs=', '2024-05-15 16:47:06.951973', 0, 'Esteban', '', '', '', 0, 1, '2024-05-15 16:47:05.853909'),
(5, 'pbkdf2_sha256$720000$eGF14tLIUq7JK1eriF25yY$WqQgcvmI8I65hSKIwzJDtxpdAdlJ6oYL6OcF0j4xUlU=', '2024-05-15 18:30:48.974284', 0, 'carlos', '', 'peres', 'Guiasestebanhc@gmail.com', 0, 1, '2024-05-15 18:30:47.869484'),
(6, 'pbkdf2_sha256$720000$LeezD7gGfwDm9RdRaPD1Lb$/6yFoynnOKCSFw4M3X38N1rRlinM0S0qR7G65brc2MI=', '2024-05-15 18:31:58.083464', 0, 'pepito', 'jose', 'felipe', 'Guiasestebanhc@gmail.com', 0, 1, '2024-05-15 18:31:56.994481'),
(7, 'pbkdf2_sha256$720000$oKqi8sTqdWedS17sOxe22q$9My86MA8TWsk6/auevbOQXqMy7GKMwxVbEhCW0Vu5PQ=', '2024-05-15 21:04:55.827516', 0, 'Esteban1', 'Esteban', 'Cavieres', 'estctm007@hotmail.com', 0, 1, '2024-05-15 20:28:04.000000'),
(8, 'pbkdf2_sha256$720000$f2TxK2uIparoPlx6CSkhLV$f7H52Z5tLbDou3tx8j5j14TbCZP9Y5M2ROqzlZW0buM=', '2024-05-16 00:59:57.151421', 0, 'kimiiku', 'vanessa', 'nuñez', 'kimiikuuu@gmail.com', 0, 1, '2024-05-16 00:58:38.362710'),
(9, 'pbkdf2_sha256$216000$OsES1Lkol48Z$tDTGAzzdEsL+2c+yLtRPjB9Ow4nfQMYF4ZX0887Tt98=', '2024-05-25 20:01:15.660483', 0, 'Esteban12', 'Esteban', 'cavieres', 'guiasestebanhc@gmail.com', 0, 1, '2024-05-25 20:01:15.397320');
...
--
-- Estructura de tabla para la tabla `core_solicitudpago`
--

CREATE TABLE `core_solicitudpago` (
  `id` int(11) NOT NULL,
  ...
  `compra_completada` tinyint(1) NOT NULL,
  `items` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Volcado de datos para la tabla `core_solicitudpago`
--

INSERT INTO `core_solicitudpago` (`id`, `precio_total`, `valor_total`, `autorizado`, `fecha_solicitud`, `fecha_autorizacion`, `autorizado_por_id`, `usuario_id`, `compra_completada`, `items`) VALUES
(1, '1500.00', '1.65', 1, '2024-05-25 19:09:56.929927', NULL, NULL, 1, 0, 1),
(2, '1500.00', '1.65', 1, '2024-05-25 19:10:29.486834', NULL, NULL, 1, 0, 1),
(3, '1500.00', '1.65', 1, '2024-05-25 19:11:53.338989', NULL, NULL, 1, 0, 1),
(4, '4500.00', '4.95', 1, '2024-05-25 19:12:42.184710', NULL, NULL, 1, 0, 3),
(5, '4500.00', '4.95', 1, '2024-05-25 19:13:51.930594', NULL, NULL, 1, 0, 3);
...
(5, 1, '1500.00', '2023-07-10 22:35:25.783555', 1, 2, 'cancelado'),
...
(11, 1, '1500.00', '2024-05-25 19:11:03.849897', 2, 4, 'Pendiente'),
(12, 1, '1500.00', '2024-05-25 19:11:03.855899', 2, 1, 'Pendiente'),
(13, 1, '1500.00', '2024-05-25 19:12:04.399961', 1, 1, 'Pendiente'),
(14, 1, '1500.00', '2024-05-25 19:12:54.940778', 1, 1, 'Pendiente'),
(15, 2, '3000.00', '2024-05-25 19:14:01.879974', 1, 1, 'preparacion'),
(16, 1, '1500.00', '2024-05-25 19:14:01.881970', 3, 1, 'cancelado');
...
(1, 'arnes UK', 1500, 44, 'El mejor arnes para hacerte pasar por un United kingdom man', '1993-01-03', 'arnes_uk_rqnCHtv.jpg', '2024-05-25', 1),
(2, 'Bandana azul', 1500, 40, 'Bandana especial de color azul, cuidado con confundir a su perro en el agua.', '2014-01-01', 'bandana_azul_LbVDVOM.jpg', '2024-05-25', 2),
(3, 'Bandana tigre', 1500, 46, 'Cuidado con asustar a los otros perros', '1940-01-01', 'bandana_print_PiystP6_PlnNpDu.png', '2024-05-25', 2),
(4, 'asdasd', 1231231, 2313, '123123', '2024-05-15', '40_FbVsnUM.jpg', '2024-05-25', 1);
...
(13, '2024-05-15 16:32:17.759546', '4', 'asdasd', 1, '[{\"added\": {}}]', 10, 1),
(14, '2024-05-15 17:05:12.290573', '5', 'asdasd', 1, '[{\"added\": {}}]', 10, 1),
(15, '2024-05-15 21:04:31.196953', '7', 'Esteban1', 2, '[{\"changed\": {\"fields\": [\"Groups\"]}}]', 4, 1),
(16, '2024-05-25 19:54:29.981475', '1', 'admin', 2, '[{\"changed\": {\"fields\": [\"Groups\"]}}]', 4, 1),
(17, '2024-05-25 19:55:54.848652', '4', 'bodeguero', 1, '[{\"added\": {}}]', 3, 1),
(18, '2024-05-25 19:56:58.495386', '5', 'contador', 1, '[{\"added\": {}}]', 3, 1),
(19, '2024-05-25 19:59:21.256519', '1', 'admin', 2, '[{\"changed\": {\"fields\": [\"Groups\"]}}]', 4, 1);
...
(23, 'core', '0005_solicitudpago', '2024-05-25 19:09:40.680143'),
(24, 'core', '0006_solicitudpago_compra_completada', '2024-05-25 19:09:40.754702'),
(25, 'core', '0007_solicitudpago_items', '2024-05-25 19:09:40.770660'),
(26, 'core', '0008_auto_20240520_1906', '2024-05-25 19:09:40.840852');
...
('49ikzohixz1uu52pqo226evl2yr7q8n8', '.eJxVjEEOwiAQRe_C2hBGaAGX7nsGMsxMpWpoUtqV8e7apAvd_vfef6mE21rS1mRJE6uLAnX63TLSQ-oO-I71Nmua67pMWe-KPmjTw8zyvB7u30HBVr51b5kJyVOOI3dj5h5tdN6DsQaAvA-O6SwOBAiCWOckxy6TGIrkJKj3BwMfOJE:1s7JQm:GhPg3qTxipWRFTPh3twd17vk3Q_zuw0XJwpyQeSfa2U', '2024-05-29 18:32:48.817656'),
...
('6dnhbo5te8jp9a0c824ueustffq66fn8', 'eyJfcGFzc3dvcmRfcmVzZXRfdG9rZW4iOiJjNzMxM2otNTk3MjNiMzcwN2YzZTgzZDNkNmU0ZTFkZDA0ZWIwNjYifQ:1s7NjS:Lu0cCwk2XntFfUU9jSfGw59kIBisEAfAlZGHsjdZCa8', '2024-05-29 23:08:22.793514'),
...
('nao6015keq9wdfhoxn87lk9hid89wruq', '.eJxVjDsOwjAQBe_iGln-JF6bkp4zWLvZDQ6gWIqTCnF3iJQC2jcz76UybmvJW5MlT6zOyqrT70Y4PGTeAd9xvlU91HldJtK7og_a9LWyPC-H-3dQsJVv3UWyEAw56YERo0BKI0ICDy6yMZHI9j6ZETF4EPLBi-vZeg6dpGFU7w_Ubzey:1sAxaR:ZktgBRhwP4GZCHkPkOuyJxmIddPwJK3PhgMdC7yY2mE', '2024-06-08 20:01:51.117500'),
...
--
-- Indices de la tabla `core_solicitudpago`
--
ALTER TABLE `core_solicitudpago`
  ADD PRIMARY KEY (`id`),
  ADD KEY `core_solicitudpago_usuario_id_4c4fc717_fk_auth_user_id` (`usuario_id`),
  ADD KEY `core_solicitudpago_autorizado_por_id_8574c326_fk_auth_user_id` (`autorizado_por_id`);
...
--
-- AUTO_INCREMENT de la tabla `core_solicitudpago`
--
ALTER TABLE `core_solicitudpago`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- Filtros para la tabla `core_solicitudpago`
--
ALTER TABLE `core_solicitudpago`
  ADD CONSTRAINT `core_solicitudpago_autorizado_por_id_8574c326_fk_auth_user_id` FOREIGN KEY (`autorizado_por_id`) REFERENCES `auth_user` (`id`),
  ADD CONSTRAINT `core_solicitudpago_usuario_id_4c4fc717_fk_auth_user_id` FOREIGN KEY (`usuario_id`) REFERENCES `auth_user` (`id`);
...
('root', '2024-05-25 19:08:18', '{\"Console\\/Mode\":\"show\",\"lang\":\"es\"}');
